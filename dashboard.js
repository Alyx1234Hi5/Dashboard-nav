...
//To add month and year sa prev and next button
function prevMonth() {
  month--;
  if (month < 0) {
    month = 11;
...
const br= document.getElementById('daychart').getContext('2d');
const daychart= new Chart(br, {
  type: 'bar',
  data: {
...
const cem= document.getElementById('weekchart').getContext('2d');
const weekchart = new Chart(cem, {
  type: 'pie',
    data: {
        datasets: [{
            data: [
...
//doughnut order in month
const dgn= document.getElementById('monthchart').getContext('2d');
const monthchart = new Chart(dgn, {
  type: 'doughnut',
    data: {
        datasets: [{
            data: [
...
const ln= document.getElementById('yearchart').getContext('2d');
const yearchart = new Chart(ln, {
  type: 'line',
  data: {
